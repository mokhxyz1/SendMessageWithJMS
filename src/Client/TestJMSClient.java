...
public class TestJMSClient {
    ...
    private String DESTINATION = "jms/queue/DLQ";
    @Test
    public void testSendReceive() throws Exception {
        ...
        try {
            ...
            env.put(Context.SECURITY_CREDENTIALS, "98628267");
            ...
            context = connectionFactory.createContext("jmsuser", "98628267");
    ...
    public static void main(String[]a) {
    	try {
			new TestJMSClient().testSendReceive();
		} catch (Exception e) {
